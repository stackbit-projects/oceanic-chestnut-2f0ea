...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://api.stackbit.com/pull/6092f0ea10dc120017394db1
...
To start editing your site, you can use the Sanity interface at https://oceanic-chestnut-2f0ea.sanity.studio/.
...
Generated at `2021-05-05T19:28:18.111Z` by Stackbit version `0.3.51`.